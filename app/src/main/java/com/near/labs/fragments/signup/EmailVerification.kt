...
class EmailVerification : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.verificationMessage.text = getString(R.string.verification_to_email)
        binding.verificationAlternative.text =
            getString(R.string.verification_send_to_different_email)
        ...
        binding.toNext.setOnClickListener {
            val action =
                EmailVerificationDirections.actionEmailVerificationToCreateAccount()
